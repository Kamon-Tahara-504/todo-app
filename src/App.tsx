...
function App() {
    ...
    return (
        <div className="title">
            ...
            {tasks.length > 0 && (
                <div className="stats">
                    <p className="delallbut" onClick={deleteAllTasks}>
                        delete all
                    </p>
                </div>
            )}
