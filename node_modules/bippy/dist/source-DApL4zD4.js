 ...
 */
import { _renderers, getRDTHook } from "./rdt-hook-BraYbuNA.js";
...
const describeFiber = (fiber, childFiber) => {
	...
	switch (tag) {
		...
		case HostComponentTag: return describeBuiltInComponentFrame(fiber.type);
		case LazyComponentTag: return describeBuiltInComponentFrame("Lazy");
