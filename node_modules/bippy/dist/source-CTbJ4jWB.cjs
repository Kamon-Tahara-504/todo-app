...
const getFiberStackFrame = (fiber) => {
	...
	const componentFunction = require_src.isHostFiber(fiber) ? require_src.getType(require_src.traverseFiber(fiber, (innerFiber) => {
		if (require_src.isCompositeFiber(innerFiber)) return true;
	}, true)?.type) : require_src.getType(fiber.type);
	if (!componentFunction || reentry) return null;
	const frame = describeNativeComponentFrame(componentFunction, fiber.tag === require_src.ClassComponentTag);
	return frame;
};
...
const describeFiber = (fiber, childFiber) => {
	const tag = fiber.tag;
	switch (tag) {
		case require_src.HostHoistableTag:
		case require_src.HostSingletonTag:
		case require_src.HostComponentTag: return describeBuiltInComponentFrame(fiber.type);
		case require_src.LazyComponentTag: return describeBuiltInComponentFrame("Lazy");
		case require_src.SuspenseComponentTag:
...
const getFiberStackTrace = (workInProgress) => {
	try {
		let info = "";
...
const getOwnerStack = async (stackTrace) => {
...
Object.defineProperty(exports, 'describeBuiltInComponentFrame', {
  enumerable: true,
  get: function () {
...
Object.defineProperty(exports, 'describeDebugInfoFrame', {
  enumerable: true,
  get: function () {
    return describeDebugInfoFrame;
  }
});
Object.defineProperty(exports, 'describeFiber', {
  enumerable: true,
  get: function () {
...
Object.defineProperty(exports, 'getFiberStackFrame', {
  enumerable: true,
  get: function () {
    return getFiberStackFrame;
  }
});
Object.defineProperty(exports, 'getFiberStackTrace', {
  enumerable: true,
  get: function () {
    return getFiberStackTrace;
  }
});
Object.defineProperty(exports, 'getOwnerStack', {
  enumerable: true,
  get: function () {
...
Object.defineProperty(exports, 'isCapitalized', {
  enumerable: true,
  get: function () {
    return isCapitalized;
  }
});
Object.defineProperty(exports, 'parseStackFrame', {
  enumerable: true,
  get: function () {
